...
cloudinary.config(
  cloud_name = "djlflucog",
  api_key = "429986143941366",
  api_secret = "nksyrme7ga-5rdhVv1nlUawDiiY",
  secure = True
)
...
SECRET_KEY = 'django-insecure-sp5$*+dw_(b%fd_-d+3lth6a$1qe5$r0lxv8ozk^#(w^h)_y_3'
